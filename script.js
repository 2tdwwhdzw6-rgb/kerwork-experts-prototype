...
const categories = ["全部","专业岗位","办公提效","产品研发","创意设计","一人公司","内容创作","数据研究","营销运营","金融法律","学习成长","求职招聘","生活娱乐","沟通表达","健康管理"];

const experts = [
  {
    name: 'PPT 设计师', icon: '🎨', cats: ["办公提效"], kw: ["ppt","幻灯片","演示","路演"], tags: ["汇报表达","结构梳理","视觉呈现"],
  ...
  {
    name: 'Excel 表格助手', icon: '📊', cats: ["办公提效"], kw: ["excel","表格","记账","公式","数据清洗"], tags: ["表格处理","公式计算","效率提升"],
  ...
  {
    name: '文件格式转换师', icon: '🔄', cats: ["办公提效"], kw: ["转换","pdf","word","ocr","格式"], tags: ["格式转换","TeX 排版","内容提取"],
  ...
  {
    name: '数据分析专员', icon: '📉', cats: ["数据研究"], kw: ["数据分析","指标","图表","归因"], tags: ["数据洞察","指标理解","图表表达"],
  ...
  {
    name: '小红书爆款文案专员', icon: '📕', cats: ["内容创作"], kw: ["小红书","种草","爆款","笔记"], tags: ["选题灵感","内容表达","标题打磨"],
  ...
  {
    name: '去AI味助手', icon: '✏️', cats: ["内容创作"], kw: ["ai味","机器感","官腔","润色"], tags: ["文风诊断","句式重写","表达自然"],
  ...
  {
    name: '工作汇报大师', icon: '📋', cats: ["办公提效"], kw: ["周报","月报","复盘","汇报","总结"], tags: ["工作梳理","重点提炼","汇报表达"],
  ...
  {
    name: '股票研究员', icon: '📈', cats: ["金融法律"], kw: ["股票","行情","研报","估值","财报"], tags: ["行情查询","财务分析","研报解读"],
  ...
  {
    name: '科研助手', icon: '🔬', cats: ["学习成长"], kw: ["文献","科研","研究","综述"], tags: ["文献阅读","观点整理","研究框架"],
  ...
  {
    name: '解忧占卜师', icon: '🔮', cats: ["生活娱乐"], kw: ["占卜","运势","塔罗","八字","抽牌"], tags: ["轻松解读","情绪陪伴","自我探索"],
  ...
  {
    name: '求职调研师', icon: '💼', cats: ["求职招聘"], kw: ["公司","面试","岗位","offer","面经"], tags: ["公司了解","岗位判断","面试准备"],
  ...
  {
    name: '电脑操作与排障助手', icon: '🖥️', cats: ["办公提效"], kw: ["电脑","c盘","卡顿","变慢","清理","文件整理"], tags: ["电脑操作","文件管理","问题排查"],
  ...
  {
    name: '个人工作台搭建', icon: '🧰', cats: ["一人公司"], kw: ["工作台","工具整合","自动化","开工流程"], tags: ["工作台搭建","工具整合","流程自动化"],
  ...
  {
    name: '市场调研员', icon: '🔍', cats: ["专业岗位","一人公司"], kw: ["调研","竞品","行业分析","市场规模"], tags: ["市场调研","竞品分析","用户洞察"],
  ...
  {
    name: '战略咨询师', icon: '♟️', cats: ["专业岗位","一人公司"], kw: ["战略","咨询","市场分析","竞品"], tags: ["战略分析","竞争研究","决策支持"],
  ...
  {
    name: '财务分析师', icon: '🧮', cats: ["专业岗位","一人公司"], kw: ["财务","利润表","成本","经营分析"], tags: ["财务分析","经营指标","预算决策"],
  ...
  {
    name: '招投标管理专家', icon: '📑', cats: ["专业岗位","一人公司"], kw: ["招标","投标","标书"], tags: ["标书撰写","资质梳理","流程管理"],
  ...
  {
    name: '公文写作助手', icon: '📜', cats: ["内容创作"], kw: ["公文","请示","通知","报告"], tags: ["公文写作","格式规范","正式表达"],
  ...
  {
    name: '微信公众号运营专家', icon: '💬', cats: ["营销运营"], kw: ["公众号","推文","打开率","微信"], tags: ["选题策划","公众号写作","内容运营"],
  ...
  {
    name: '小红书发布助手', icon: '📤', cats: ["营销运营"], kw: ["发布","定时","排期","笔记数据"], tags: ["笔记发布","定时排期","数据回访"],
  ...
  {
    name: '爆款短剧策划师', icon: '🎬', cats: ["内容创作"], kw: ["短剧","剧本","剧情","反转"], tags: ["故事策划","剧本结构","短剧创作"],
  ...
  {
    name: '直播脚本策划师', icon: '🎙️', cats: ["内容创作"], kw: ["直播","脚本","话术"], tags: ["直播脚本","话术设计","流程编排"],
  ...
  {
    name: '短视频运营专家', icon: '📹', cats: ["营销运营"], kw: ["短视频","抖音","快手","视频号"], tags: ["账号定位","爆款选题","粉丝增长"],
  ...
  {
    name: '海报设计师', icon: '🖼️', cats: ["创意设计"], kw: ["海报","视觉","配图"], tags: ["视觉创意","版式设计","宣传物料"],
  ...
  {
    name: '官网设计师', icon: '🌐', cats: ["创意设计"], kw: ["官网","网页设计","网站"], tags: ["网页设计","视觉规范","落地页转化"],
  ...
  {
    name: '直播运营助手', icon: '📺', cats: ["营销运营"], kw: ["直播运营","场控","复盘"], tags: ["直播运营","流量提升","互动转化"],
  ...
  {
    name: 'SEO优化助手', icon: '🌐', cats: ["营销运营"], kw: ["seo","关键词","搜索排名","收录"], tags: ["关键词研究","内容优化","搜索增长"],
  ...
  {
    name: '中国电商运营专家', icon: '🛒', cats: ["营销运营"], kw: ["电商","店铺","转化","详情页"], tags: ["店铺运营","平台规则","转化优化"],
  ...
  {
    name: '跨境电商运营专家', icon: '🌍', cats: ["营销运营"], kw: ["跨境","出海","亚马逊","temu"], tags: ["跨境运营","Listing 优化","物流合规"],
  ...
  {
    name: '亚马逊广告投放师', icon: '📣', cats: ["营销运营"], kw: ["亚马逊","广告","acos","投放"], tags: ["广告投放","关键词优化","成本控制"],
  ...
  {
    name: '资产规划顾问', icon: '💰', cats: ["金融法律"], kw: ["理财","资产配置","保险","养老"], tags: ["收支管理","预算规划","风险提示"],
  ...
  {
    name: '诉讼支持顾问', icon: '⚖️', cats: ["金融法律"], kw: ["诉讼","纠纷","证据","起诉"], tags: ["案情梳理","证据整理","诉讼流程"],
  ...
  {
    name: '合同审查专家', icon: '📑', cats: ["金融法律"], kw: ["合同","条款","违约","审查"], tags: ["条款审查","风险识别","合同修改"],
  ...
  {
    name: '法律文书助手', icon: '🖋️', cats: ["金融法律"], kw: ["法律文书","起诉状","文书"], tags: ["文书起草","事实整理","格式规范"],
  ...
  {
    name: '考前知识点突击助手', icon: '📚', cats: ["学习成长"], kw: ["学习","复习","错题","讲解"], tags: ["知识讲解","学习计划","错题复盘"],
  ...
  {
    name: '论文写作助手', icon: '🎓', cats: ["学习成长"], kw: ["论文","提纲","参考文献","学术"], tags: ["论文结构","学术表达","格式检查"],
  ...
  {
    name: '高考志愿填报助手', icon: '🎓', cats: ["学习成长"], kw: ["高考","志愿","填志愿","报志愿"], tags: ["志愿填报","院校分析","分数定位"],
  ...
  {
    name: '留学升学顾问', icon: '✈️', cats: ["学习成长"], kw: ["留学","申请","托福","雅思"], tags: ["院校调研","申请规划","材料准备"],
  ...
  {
    name: '求职辅导助手', icon: '🎯', cats: ["求职招聘"], kw: ["求职","面试辅导","求职计划"], tags: ["求职定位","面试准备","行动计划"],
  ...
  {
    name: '招聘助手', icon: '🧑‍💼', cats: ["求职招聘"], kw: ["招聘","简历筛选","面试流程"], tags: ["岗位分析","候选人筛选","招聘流程"],
  ...
  {
    name: '简历优化助手', icon: '📃', cats: ["求职招聘"], kw: ["简历","经历提炼","岗位匹配"], tags: ["简历改写","经历提炼","岗位匹配"],
  ...
  {
    name: '人力资源顾问', icon: '👥', cats: ["求职招聘"], kw: ["hr","招聘流程","绩效","入离职"], tags: ["HR 流程","绩效管理","员工关系"],
  ...
  {
    name: '个人健康管理师', icon: '💚', cats: ["健康管理"], kw: ["健康","饮食","运动","睡眠"], tags: ["健康管理","作息规划","习惯养成"],
  ...
  {
    name: '体检报告解读专家', icon: '🩺', cats: ["健康管理"], kw: ["体检","报告解读","指标异常"], tags: ["报告解读","指标分析","就医建议"],
  ...
  {
    name: '宠物健康咨询助手', icon: '🐾', cats: ["健康管理"], kw: ["宠物","猫","狗","疫苗"], tags: ["宠物健康","症状分析","养护建议"],
  ...
  {
    name: '八字命理解读师', icon: '☯️', cats: ["生活娱乐"], kw: ["八字","命理","生辰","五行"], tags: ["八字分析","命理解读","运势参考"],
  ...
  {
    name: '星座运势', icon: '🔭', cats: ["生活娱乐"], kw: ["星座","星盘","水逆","占星"], tags: ["星盘解读","星座配对","运势分析"],
  ...
  {
    name: '姻缘占卜师', icon: '💘', cats: ["生活娱乐"], kw: ["姻缘","桃花","正缘","脱单"], tags: ["姻缘测算","缘分分析","情感解读"],
  ...
  {
    name: '特朗普嘴替', icon: '🗣️', cats: ["生活娱乐"], kw: ["嘴替","吐槽","模仿","特朗普"], tags: ["口吻模仿","犀利点评","娱乐吐槽"],
  ...
  {
    name: '数据分析报告专家', icon: '📊', cats: ["数据研究"], kw: ["报告","bi","可视化","取数"], tags: ["指标口径","数据质量","分析报告"],
  ...
  {
    name: '深度研究专家', icon: '🧠', cats: ["数据研究"], kw: ["深度研究","调研","尽调","交叉验证"], tags: ["问题定义","资料检索","证据核验"],
  ...
  {
    name: '个人知识库助手', icon: '📚', cats: ["数据研究"], kw: ["知识库","笔记","obsidian","notion"], tags: ["知识整理","资料索引","定期复盘"],
  ...
  {
    name: '高情商回复助手', icon: '💬', cats: ["沟通表达"], kw: ["高情商","回复","话术","得体"], tags: ["语气拿捏","关系判断","多版本回复"],
  ...
  {
    name: '客服助手', icon: '🎧', cats: ["沟通表达"], kw: ["客服","售后","退款","工单"], tags: ["客户咨询","情绪安抚","服务升级"],
  ...
  {
    name: '情感沟通助手', icon: '❤️', cats: ["沟通表达"], kw: ["情感","恋爱","聊天","关系"], tags: ["情绪澄清","关系沟通","边界建议"],
  ...
  {
    name: '表达提升专家', icon: '🎤', cats: ["沟通表达"], kw: ["口才","演讲","表达","汇报"], tags: ["结构优化","措辞调整","表达练习"],
  ...
  {
    name: '爽文小说创作专家', icon: '📖', cats: ["内容创作"], kw: ["爽文","小说","网文","大纲","金手指"], tags: ["爽点设计","大纲架构","人设打磨"],
    desc: '懂爽点节奏的网文创作搭档：从人设、金手指到分卷大纲，帮你把脑洞写成让人一路追更的爽文。',
    examples: [
      '帮我设计一个都市爽文的金手指',
      '把我的脑洞扩成分卷大纲',
      '这一章不够爽，帮我加点爽点'
...
function termScore(e, term) {
  ...
  if (e.cats.some(c => fieldHit(c, term)) || fieldHit(e.desc, term)) return 1;
  return -1;
}
...
function getFilteredExperts() {
  ...
  if (activeCategory !== '全部') {
    list = list.filter(({ e }) => activeCategory === '全部' || e.cats.includes(activeCategory));
  }
  if (searchQuery.trim()) {
...
/* ========== Banner 轮播 ========== */
const bannerRoleNames = ['前端开发工程师', '后端架构师', '产品经理', '代码审查员', '项目管理师', '运营增长专家', '招投标管理专家', '市场调研员', '战略咨询师', '财务分析师', '简历筛选助手（hr专用）'];
    ...
    <div class="modal-header">
      ...
      <div>
        ...
        <div class="modal-meta">
          ${e.cats.map(c => `<span class="modal-cat">${c}</span>`).join('')}
